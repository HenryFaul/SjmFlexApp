...
class ImportRingTube implements ToCollection, WithHeadingRow
{
    /**
    ...
    */
    public function collection(Collection $collection)
    {
        ...
        //Model	capa	Syspro Codes	Flex Type	Bom
        ...
        foreach ($collection as $row) {
            if ($row != null) {
                ...
                if ($row['model'] != '') {
                    ...
                    $found_ring_tube = RingTube::where('model_type_id',$model_type_id)->where('flex_type_id',$flex_type_id);

                    if ($found_ring_tube == null){
