...
const classesProductInfo = computed(() => {
    return route().current('import.index') ||  route().current('production-model.index')
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        <div class="flex">
                                    ...
                                    <div :class="classesProductInfo">
                                        <Dropdown align="right" width="48">
                                            ...
                                            <template #content>
                                                ...
                                                <DropdownLink :href="route('staff_member.index')">
                                                    All Staff
                                                </DropdownLink>
                                ...
                                <div class="ml-3 relative">
                                    <div :class="classesProductInfo">
                                        <Dropdown align="right" width="48">
                                            ...
                                            <template #content>
                                                <DropdownLink :href="'/component_line/' + 'Interlock'">
                                                    Interlock Lines
                                                </DropdownLink>

                                                <DropdownLink :href="'/component_line/' + 'Braiding'">
                                                    Braiding Lines
                                                </DropdownLink>

                                                <dropdown-link :href="'/component_line/' + 'Knitting'">
                                                    Knitting Lines
                                                </dropdown-link>

                                                <dropdown-link :href="'/component_line/' + 'Tubing'">
                                                    Tubing Lines
                                                </dropdown-link>

                                                <dropdown-link :href="'/component_line/' + 'Assembly'">
                                                    Assembly Lines
                                                </dropdown-link>

                                                <dropdown-link :href="'/component_line/' + 'Grammage'">
                                                    Grammage Lines
                                                </dropdown-link>

                                                <dropdown-link :href="'/component_line/' + 'Slitting'">
                                                    Slitting Lines
                                                </dropdown-link>
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <NavLink :href="'/component_line/create'" :active="route().current('component_line')">
                                    Create +
                                </NavLink>
                            </div>
